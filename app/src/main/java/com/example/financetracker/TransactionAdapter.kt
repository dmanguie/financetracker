// app/src/main/java/com/example/financetracker/TransactionAdapter.kt
...
class TransactionAdapter(
    ...
    private val onDelete: (String) -> Unit   // ← String now (Firestore doc ID)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnDelete.setOnClickListener { onDelete(t.id) }   // String id
    }
